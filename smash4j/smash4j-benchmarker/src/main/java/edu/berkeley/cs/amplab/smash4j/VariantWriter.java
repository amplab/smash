...
public class VariantWriter {
  ...
  private final Function<? super Iterable<VariantProto>, ? extends Iterable<VariantProto>> transformer;
  ...
  public VariantWriter transform(Function<? super Iterable<VariantProto>, ? extends Iterable<VariantProto>> transformer) {
  ...
  public VariantWriter writeVariants(VariantScanner scanner) throws Exception {
    return scanner.scan(
        new VariantScanner.Callback<VariantWriter>() {
          @Override public VariantWriter accept(FluentIterable<VariantProto> variants)
              throws Exception {
