...
public final class Call extends com.google.api.client.json.GenericJson {
   ...
   * field or a 1-based index into alternateBases. If a variant had a referenceBases field of "T"
   * and an alternateBases value of ["A", "C"], and the genotype was [2, 1], that would mean the
