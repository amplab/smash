...
public class Genomics extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the Experimental collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Genomics genomics = new Genomics(...);}
   *   {@code Genomics.Experimental.List request = genomics.experimental().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Experimental {
    ...
    public class Jobs {
      ...
      /**
       * Creates and asynchronously runs an ad-hoc job. NOTE: This is an experimental call and may vanish
       ...
       * parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param content the {@link com.google.api.services.genomics.model.ExperimentalCreateJobRequest}
       * @return the request
       */
      public Create create(com.google.api.services.genomics.model.ExperimentalCreateJobRequest content) throws java.io.IOException {
        Create result = new Create(content);
        initialize(result);
        return result;
      }

      public class Create extends GenomicsRequest<com.google.api.services.genomics.model.ExperimentalCreateJobResponse> {

        private static final String REST_PATH = "experimental/jobs/create";

        /**
         * Creates and asynchronously runs an ad-hoc job. NOTE: This is an experimental call and may
         * vanish or change without warning.
         *
         * Create a request for the method "jobs.create".
         *
         * This request holds the parameters needed by the the genomics server.  After setting any
         ...
         * @since 1.13
         */
        protected Create(com.google.api.services.genomics.model.ExperimentalCreateJobRequest content) {
          super(Genomics.this, "POST", REST_PATH, content, com.google.api.services.genomics.model.ExperimentalCreateJobResponse.class);
        }
  ...
  public class Jobs {
    ...
    /**
     * An accessor for creating requests from the Deprecated collection.
     *
     * <p>The typical use is:</p>
     * <pre>
     *   {@code Genomics genomics = new Genomics(...);}
     *   {@code Genomics.Deprecated.List request = genomics.deprecated().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    public class Deprecated {
       ...
       *
       * Create a request for the method "deprecated.get".
       *
       * This request holds the parameters needed by the genomics server.  After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
      ...
      public class Get extends GenomicsRequest<com.google.api.services.genomics.model.Job> {
        ...
        private static final String REST_PATH = "jobs/deprecated/{jobId}";
