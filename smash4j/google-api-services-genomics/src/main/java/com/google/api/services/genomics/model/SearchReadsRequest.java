...
public final class SearchReadsRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * If specified, will restrict this query to reads within the given readsets. At least one readset
   * ID must be provided.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * The start position (1-based, inclusive) of this query. If a sequence name is specified, this
   * defaults to 1.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
