...
public final class SearchReadsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The list of matching Reads. The resulting Reads are sorted by position; the smallest positions
   * are returned first. Unmapped reads, which have no position, are returned last and are further
