...
public final class Read extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A score up to 255 that represents how likely this read's aligned position is to be correct. A
   * higher value is better. (MAPQ)
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * The name of the sequence that this read is aligned to. This would be, for example, 'X' for the
   * X Chromosome or '20' for Chromosome 20. (RNAME)
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
